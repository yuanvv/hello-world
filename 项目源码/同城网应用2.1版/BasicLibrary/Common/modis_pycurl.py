...
def get_modis_by_pycurl():
    ...
    # 数据文件下载地址
    url = 'https://search.earthdata.nasa.gov/search?m=-0.0703125!0!2!1!0!0%2C2&fl=2%20-%20Geophys.%20Variables%2C%20Sensor%20Coordinates&gdf=NetCDF'
    ...
    # 解析内容，取得验证用户的链接
    pu = re.compile(r'href="(https://ladsweb.modaps.eosdis.nasa.gov/search/)"')        
